<template>
      <div class="grid min-h-[140px] w-full place-items-center overflow-x-scroll rounded-lg p-6 lg:overflow-visible h-screen items-center justify-center" v-if="loading">
      ...
      <div class="grid grid-cols-2 gap-1 ml-5" v-else>
